...
public class InsertRequirementState extends State {

	/**
	 * Dodaje Zahtev na poziciju kursora ako na toj poziciji već
	 * ne postoji nod.
	 */
	@Override
	public void mousePressed(MouseEvent e) {
		...
		if (e.getButton() == MouseEvent.BUTTON1) {
			...
			if (node == -1) {
				Node n = Requirement.createDefault(v.lastPosition, m
						.getNodeCount() + 1);
	...
	public void enter() {
		Application.getInstance().getView().setCursor(
				Cursors.getCursor("insertRequirement"));
	}
}

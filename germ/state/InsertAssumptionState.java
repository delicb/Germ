...
public class InsertAssumptionState extends State {

	/**
	 * Dodaje Pretpostavku na poziciju kursora ako na toj poziciji već
	 * ne postoji nod.
	 */
	@Override
	public void mousePressed(MouseEvent e) {
		...
		if (e.getButton() == MouseEvent.BUTTON1) {
			...
			if (node == -1) {
				Node n = Assumption.createDefault(v.lastPosition, m
						.getNodeCount() + 1);
	...
	public void enter() {
		Application.getInstance().getView().setCursor(
				Cursors.getCursor("insertAssumption"));
	}
}

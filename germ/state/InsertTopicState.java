...
public class InsertTopicState extends State {

	/**
	 * Dodaje temu na poziciju kursora ako na toj poziciji već
	 * ne postoji nod.
	 */
    @Override
	public void mousePressed(MouseEvent e) {
		...
		if (e.getButton() == MouseEvent.BUTTON1) {
			...
			if (node == -1) {
				Node n = Topic.createDefault(v.lastPosition, m.getNodeCount()+1);

...
public class InsertPositionState extends State {

	/**
	 * Dodaje Poziciju na poziciju kursora ako na toj poziciji već
	 * ne postoji nod.
	 */
	@Override
	public void mousePressed(MouseEvent e) {
		...
		if (e.getButton() == MouseEvent.BUTTON1) {
			...
			if (node == -1) {
				Node n = Position.createDefault(v.lastPosition, m
						.getNodeCount() + 1);
	...
	public void enter() {
		Application.getInstance().getView().setCursor(
				Cursors.getCursor("insertPosition"));
	}
}
